...
<h3 align ="center">A batch of Original Dataset (Left) VS a batch of Generated by the DCGAN (Right)</h3>
<p align="center">
  <img src="imgs/original_batch.png" alt="original" style="width:40%; height:auto; margin-right:200px;">
  
  <img src="imgs/generated_batch.png" alt="generated" style="width:40%; height:auto;  margin: 0 200px;">
</p>
...
Which means that the Tuberculosis or also Diagnosed Class has a ratio of 1 to 5 to the Normal Class.
